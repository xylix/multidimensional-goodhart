# Optional supporting artifacts outside the paper

Extracted from `polish.md` §11 (June 9, 2026) when the manuscript polish
pipeline completed and that file was archived. These are optional repo-side
artifacts, not manuscript work.

- Add a short machine-learning worked contract in `research/applications/`
